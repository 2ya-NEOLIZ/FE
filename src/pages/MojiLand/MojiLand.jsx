...
const sr = {
  ...
  meBadge: { position: 'absolute', top: 8, left: 10, color: '#ff4444', fontSize: 14, fontWeight: 'bold' },
  ...
  meTag: { color: '#ff4444', fontSize: 14, fontWeight: 'bold', minWidth: 20, fontFamily: FONT },
